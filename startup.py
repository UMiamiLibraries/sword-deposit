""" 
In this sample, the Flask app object is contained within the web_app *module*;
that is, web_app contains an __init__.py along with relative imports. Because
...
from web_app.webapp import app
